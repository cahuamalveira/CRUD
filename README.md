CRUD(Cadastro, listagem, Edição e exclusão) em um sistema de fluxo entre apartamentos e moradores. Utilizando obrigatoriamente PHP e Mysql, podendo usar outras linguagens complementares.
